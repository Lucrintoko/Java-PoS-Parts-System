...
public class GridLayout {
    public static void main(String[] args) {
        ...
        JButton button2 = createButton("AMD", "AMDD.png");
        JButton button3 = createButton("Corsair", "corsair.png");
        JButton button4 = createButton("NVIDIA", "nvidia.png");
        JButton button5 = createButton("Samsung", "samsungg.png");
